...
//jika tidak ada session pelanggan / belum login mka dilarikan ke login.php
...
<section class="kontent">
	<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" readonly value=" <?php echo $_SESSION["pelanggan"]['nama_pelanggan'] ?>"  class="form_control">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" readonly value=" <?php echo $_SESSION["pelanggan"]['telepon_pelanggan'] ?>"  class="form_control">
					</div>
				</div>
				<div class="col-md-4">
					<select class="form_control" name="id_ongkir">
		...
		<textarea class="form-control" name="alamat_pengiriman" placeholder="Masukkan alamat lengkap pengirimn(Termasuk kode pos)"></textarea>
	</div>
